...
def create_profile():
    ...
    Returns:
    - profile (tuple): Tuple containing the profile information.
    """
...
def parse_template(template):
    ...
    Returns:
    - cleaned_template (str): The template string with placeholders removed.
...
def merge(template, placeholders):
    """
    Merge a template string and a tuple of placeholders.
    ...
    Returns:
    - merged_string (str): The merged string with placeholders replaced by corresponding values.
    """
